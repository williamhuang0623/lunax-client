...
import { AuctionEnded, AuctionItemCreated, HighestBidIncreased } from '../generated/schema';

export function handleAuctionEnded(event: AuctionEndedEvent): void {
    let entity = new AuctionEnded(event.transaction.hash.toHex() + '-' + event.logIndex.toString());
...
export function handleHighestBidIncreased(event: HighestBidIncreasedEvent): void {
